-- Complete script to update all events
-- Run this in Supabase SQL Editor to delete existing events and add recurring weekly events
...
-- Step 2: Helper function to get next occurrence of a day of the week
...
-- Step 3: Insert Monday Morning Runs (12 weeks)
...
-- Step 4: Insert Thursday Padel Nights (12 weeks)
INSERT INTO events (title, description, type, date, duration_minutes, location, max_slots, is_featured, is_free, price_cents, pricing_note)
SELECT 
    'Padel Night',
...
-- Step 5: Insert Friday Girls Only Runs (12 weeks)
INSERT INTO events (title, description, type, date, duration_minutes, location, max_slots, is_featured, is_free, price_cents, pricing_note)
SELECT 
...
-- Step 7: Show summary of inserted events
SELECT 
    title,
