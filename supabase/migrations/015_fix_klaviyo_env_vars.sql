-- Migration: Fix Klaviyo integration environment variable names
-- Updates the handle_new_user function to use correct env var names

-- Update the handle_new_user function with correct environment variable names
