-- Migration: Add event pricing support for hybrid free/paid model
-- This migration adds pricing fields to events and supports individual payments for free members
